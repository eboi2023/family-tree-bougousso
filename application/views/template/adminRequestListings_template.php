    ...
    <div class="container">
        ...
        <?php
            ...
            foreach ($data as $row){
				...
				<div class="col col-5" data-label="enddate"><?php echo $endDate ?></div>
				<div class="col col-7" data-label="Status"><?php echo "<a href='",site_url('deleteRequest'),"?id=".$idApproval."' class = 'effect1 delete'>Delete Request</a>"?></div>
			</li><?php
            }
        ?>
        </ul>
