      ...
      <div class="container-fluid">
        ...
        <div class="card card-default col-md-6">
          <div class="card-header">
            <h3 class="card-title"><?php echo get_phrase('type_personne',3); ?></h3>
            ...
            <div class="row">
              <div class="col-md-6">
                <div class="form-group">
                  <label><?php echo get_phrase('my',3); ?>*</label>
                ...
                <!-- /.form-group -->
                <div class="form-group">
                  <label><?php echo get_phrase('to',3); ?>*</label>
                  <select class="form-control select2" data-placeholder="Select a State" style="width: 100%;">
                    ...
                    <option>de mere</option>
                    <option>de pere</option>

                    <option>grand pere</option>
                    <option>grande mere</option>
                    <option></option>
                    <option></option>
                    <option></option>
                  </select>
