  ...
  <body>
    <div id="container">
      <div id="error-box" >
        ...
        <div class="message">
          <h1 class="alert">
            <?php echo get_phrase('Error!',3); ?>
          </h1>
          <p>
            <?php echo get_phrase('oh no, unknown email address.',3); ?>
          </p>
        </div>
        <button class="button-box"><h1 class="red"><a href="<?php echo site_url('passwordnew')?>"><?php echo get_phrase('try again',3); ?></a></h1></button>
      </div>
    </div>
  </body>
