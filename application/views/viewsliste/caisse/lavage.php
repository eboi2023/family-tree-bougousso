...
<div class="content-wrapper">
    ...
    <section class="content-header">
        ...
        <small><?= get_phrase("Caisse LAVAGE"); ?></small>
      </h1>
        <ol class="breadcrumb">
            ...
            <li class="active"> <i class="glyphicon glyphicon-bishop"></i>&nbsp;<?php echo get_phrase('lavage'); ?></li>
        </ol>
    </section>
    <!-- Main content -->
        ...
        <div class="row">
            <div class="pull-left col-xs-12">
                <?php if(in_array('createCaisse', $this->permission)) {?>
                    ...
                    <a class="btn btn-success" href="<?php echo site_url();?>caisses/lavage/refresh"><i class="fa fa-refresh" title="&nbsp;<?php echo get_phrase('restor'); ?>"></i></a>
            ...
            <div class="modal-body box box-success">
                <?php echo form_open('') ; ?>
                    <div class="box-body">
                        ...
                        <div class="form-group col-md-12" id="personne">
                        </div>

                        
                        <label for="montant"><?php echo get_phrase('Montant'); ?></label>
...
<?php 
    $select1="<select class='form-control col-md-6' name='nom_type' id='nom_tye' required ><option  >".get_phrase('Acte realise')."</option>";
    if($aff_type1){
    ...
    $select2="<select class='form-control col-md-6' name='nom_type' id='nom_tye' required ><option  >".get_phrase('Acte realise')."</option>";
    if($aff_type2){
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        manageTable = $('#manageTable').DataTable({
            ...
            'info'        : true,
            'autoWidth'   : false,
            'ajax': base_url + 'Caisses/fetchCaisseData/1',
            'order': []
