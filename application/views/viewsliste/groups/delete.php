  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active"><i class="fa fa-plug" ></i> <?php echo get_phrase('Delete'); ?> <?php echo get_phrase('Personal post'); ?></li>
          ...
          <h1><?php echo get_phrase('Do you really want to remove ?'); ?></h1>
            ...
            <?php 
              $attributes = array("class" => "",
                                  ...
                                  "id" => "",
                                  "name" => "");
              echo form_open("Groups/delete/".$id, $attributes);
            ?> 
            <input type="submit" class="btn btn-primary" name="confirm" value="<?php echo get_phrase('Confirm'); ?>">
            <a href="<?php echo base_url('Groups') ?>" class="btn btn-warning"><?php echo get_phrase('Cancel'); ?></a>
          <?php echo form_close(); ?>
