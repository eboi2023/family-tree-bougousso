                    ...
                    <table id="manageTable" class="table table-striped table-bordered dt-responsive nowrap">
                        <thead>
                            <tr>
                                ...
                                <th width="15%">
                                    <center><?php echo get_phrase('To'); ?></center>
                                </th>
                                <th width="25%">
                        ...
                        <tfoot>
                            <tr>
                                ...
                                <td width="15%"><?php echo get_phrase('to'); ?></td>
...
<?php 
    ...
    $type_personn="<input type='text' class='form-control' name='type_indivi' id='type_indivi' placeholder='".get_phrase('type de personne ou d entreprise')."' >";
?>
